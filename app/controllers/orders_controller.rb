class OrdersController < ApplicationController
  ...
  private
    ...
    def order_params
      # params.require(:order).permit(:order_date, :age, :sex, :client_note, :other_note, :patient_id, :client_id)
      params.permit(:order_date, :age, :sex, :client_note, :other_note, :patient_id, :client_id)
    end
end
